...
- validation results
- validation result references with stable artifact ids
...
- Prefer explicit entrypoints that tell the next agent which artifact to inspect
  first, then where the replay-ready report lives.
